        ...
        Condition = {
          ...
          StringLike = {
            "token.actions.githubusercontent.com:sub" = [
              ...
              "repo:${var.github_org}/MaroonLedger-Pipeline:*"
            ]
          }
        }
      }
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Action = "iam:PassRole"
        Resource = [
          "arn:aws:iam::${var.account_id}:role/${var.project_name}-ecs-execution",
          "arn:aws:iam::${var.account_id}:role/${var.project_name}-ecs-task"
        ]
      },
      {
        Sid    = "S3Frontend"
